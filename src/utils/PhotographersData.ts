export default [
  ...
  {
    name: 'Eva Barcellos de Jesus',
    bio:
      '“Sou de Colégio, zona norte do Rio de Janeiro. Não conhecia muito bem esse lado artístico da fotografia, e foi muito importante para mim, diferente e divertido, produzir a série apresentada. Posso dizer que tenho muito aprender, e que estou muito feliz.”',
  },
  {
    name: 'Isabela Espíndola',
    bio:
      '“Fotógrafa e Artista Visual formada em Cinema, sou natural do Rio de Janeiro. Desde 2018, venho desenvolvendo trabalhos autorais sobre processos alternativos, com ênfase em cianotipia. Busco o experimentalismo e o hibridismo de técnicas em seus processos criativos. Sempre curiosa.”',
  },
  {
  ...
  },
  {
    name: 'Laiane Teles',
    bio:
      '“Sou baiana, pesquisadora, e mestranda em Filosofia pela Universidade Federal do Ceará. Eu me interesso pelas relações entre Filosofia, Literatura e Artes Visuais. Minhas imagens são em sua maioria resultados de exercícios de observação de singularidades cotidianas, numa tentativa de ver o mundo de forma mais sensível e atenta, de me relacionar com os lugares, seus espaços, cores, ritmos, história, memória. Este ensaio é resultado disso.”',
  },
  {
    name: 'Louise P.',
    bio:
  ...
  },
  {
    name: 'Priscila Gomes',
    bio:
      '“De Fortaleza, Ceará, fotografo desde 2017. De lá para cá, tenho buscado uma identidade mais autoral na fotografia. Integro um programa formado por mulheres fotógrafas, chamado Sol para Mulheres, e, nessa série final, procurei refletir um pouco minha afinidade pela a cor e pela fotografia de rua.”',
  },
  {
    name: 'Thaiane Oliveira',
    bio:
      '“Moro em São Gonçalo, Rio de Janeiro. Minha câmera é uma companheira de longa data. Apesar de eu ter a fotografia como hobby, tenho o desejo de estudar mais essa arte. O projeto Ecofoto, nessa edição remota, foi a oportunidade perfeita para que eu, finalmente, desse o primeiro passo. Esse processo do ciclo de criação me fez buscar novos ambientes, ensaiar novas possibilidades de edições e descobrir minhas referências visuais.”',
  },
];
